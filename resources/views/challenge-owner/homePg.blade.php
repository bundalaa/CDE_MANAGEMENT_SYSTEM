            ...
            <main role="main">
                <div class="jumbotron">
                    <div class="container">
                        ...
                        <p>CDE is a new education method which intends to enable students to identify problem in the
                            communities and find the concrete solution,Aimed at enhancing a scalable working skills such
                            as problem solving and team collaboration skills.</p>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <p>In this section you can upload your Challenge/Problem and will reach us then we will come
                                up with concrete solution of your challenge/problem... </p>
                            <p><a class="btn btn-secondary" href="#" role="button">View details &raquo;</a></p>
                        </div>
                        <div class="col-md-4">
                            <h2>Feeback</h2>
                            <p>This section will help you as our customer to get the progress/project status and you
                                will be able to write back your comment about the progress and if you have some changes
                                you can add as a comment... </p>
                            <p><a class="btn btn-secondary" href="#" role="button">View details &raquo;</a></p>
                        </div>
                        <div class="col-md-4">
                            <h2>Publication</h2>
                            <p>Here you can see our publications about material related to what we are doing and other
