            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <p>In this section you can upload your Challenge/Problem and will reach us then we will come up
                            with concrete solution of your challenge/problem... </p>

                    </div>
                    <div class="col-md-4">
                        <h2>Feeback</h2>
                        <p>This section will help you as our customer to get the progress/project status and you will be
                            able to write back your comment about the progress and if you have some changes you can add
                            as a comment... </p>
                ...
                <div class="container">
                    ...
                    <div class="row" style="margin:0px;">
                        ...
                        <div class="col-md-3">
                            <a href="https://dlab.or.tz/"><img src="images/th7.jpg" class="img-rounded"
                                    alt="Cinque Terre" width="304" height="236"> </a>
                        </div>
                        <div class="col-md-3">
                            <a href=""><img src="images/th5.jpg" class="img-rounded" alt="Cinque Terre" width="304"
                                    height="236"></a>
                        </div>
                        <div class="col-md-3">
                            <a href=""> <img src="images/th5.jpg" class="img-rounded" alt="Cinque Terre" width="304"
